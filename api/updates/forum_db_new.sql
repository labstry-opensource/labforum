...
--
-- 主機： localhost:3306
-- 產生時間： 2020 年 01 月 19 日 09:11
-- 伺服器版本： 8.0.18-0ubuntu0.19.10.1
-- PHP 版本： 7.3.11-0ubuntu0.19.10.1
...
INSERT INTO `ipcheck` (`ipaddr`) VALUES
('218.255.185.19'),
('218.255.185.19'),
('185.87.48.11'),
('178.159.37.34'),
...
--
-- 資料表結構 `laf_moderators`
--

CREATE TABLE `laf_moderators` (
  `fid` int(11) NOT NULL,
...
--
-- 傾印資料表的資料 `laf_moderators`
--

INSERT INTO `laf_moderators` (`fid`, `moderator_id`, `expire_date`) VALUES
(1, 13, NULL);
...
--
-- 資料表索引 `laf_moderators`
--
ALTER TABLE `laf_moderators`
  ADD PRIMARY KEY (`fid`,`moderator_id`);
