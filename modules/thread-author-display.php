...
<section class="thread-show">
    ...
    <div class="container py-4 pushed-el-cards" data-title="{{:topic_name}}"
        ...
        <div class="action-btn-wrapper text-center">
            <button class="btn btn-light" type="button" style="border-radius: 25px" data-toggle="modal" data-target="#historyModal-{{:reply_id ? reply_id : 'OP'}}">
                <!-- inline history svg -->
    ...
    <div class="modal fade" id="historyModal-{{:reply_id ? reply_id : 'OP'}}" tabindex="-1" role="dialog" aria-labelledby="Thread Modifying History" aria-hidden="true">
