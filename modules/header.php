...
<head>
    ...
    <script src="<?php echo $home_url?>/js/toggle.js?<?php
...
<body>
<div class="nav-search-wrapper container" style="position:fixed; top: 0; left: 0; right: 0; overflow-x: hidden; z-index: 1041">
        ...
        <header class="" style="">
            <div class="container header-el-wrapper">
                <div class="h-100 d-flex align-items-center">
                    ...
                    <a href="<?php echo $links['title']['link']?>"
                       class="title-name text-decoration-none mx-3">
                ...
                <div class="header-right-btn-wrapper position-absolute" style="">
                    ...
                    if (! @$_SESSION['username']):
                        ...
                        <a class="btn d-inline" style="color: white" href="/login.php">
                            ...
                            <svg class="svg-inline--fa fa-user fa-w-14" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                <path fill="#4bd2b0" d="M224 256c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128zm89.6 32h-16.7c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16h-16.7C60.2 288 0 348.2 0 422.4V464c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48v-41.6c0-74.2-60.2-134.4-134.4-134.4z"></path>
                            </svg>
                        </a>
                        <a href="<?php
                        ...
                        echo $home_url?>/register.php" class="btn d-inline">
                            <svg class="svg-inline--fa fa-user-plus fa-w-16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                <path fill="#4bd2b0" d="M624 208h-64v-64c0-8.8-7.2-16-16-16h-32c-8.8 0-16 7.2-16 16v64h-64c-8.8 0-16 7.2-16 16v32c0 8.8 7.2 16 16 16h64v64c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16v-64h64c8.8 0 16-7.2 16-16v-32c0-8.8-7.2-16-16-16zm-400 48c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128zm89.6 32h-16.7c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16h-16.7C60.2 288 0 348.2 0 422.4V464c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48v-41.6c0-74.2-60.2-134.4-134.4-134.4z"/></svg>
                        </a>
                    <?php
                    endif;
                    ?>
                    <a href="#" class="search-btn-toggle btn d-inline">
                        <svg class="svg-inline--fa fa-search fa-w-16" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="search" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                            <path fill="#4bd2b0" d="M505 442.7L405.3 343c-4.5-4.5-10.6-7-17-7H372c27.6-35.3 44-79.7 44-128C416 93.1 322.9 0 208 0S0 93.1 0 208s93.1 208 208 208c48.3 0 92.7-16.4 128-44v16.3c0 6.4 2.5 12.5 7 17l99.7 99.7c9.4 9.4 24.6 9.4 33.9 0l28.3-28.3c9.4-9.4 9.4-24.6.1-34zM208 336c-70.7 0-128-57.2-128-128 0-70.7 57.2-128 128-128 70.7 0 128 57.2 128 128 0 70.7-57.2 128-128 128z"></path></svg>
                    </a>
                </div>
            </div>
            <ul class="container link-container mb-0">
                ...
                foreach ($links['page_links'] as $page_link) {
                    ?>
                    <li class="header-link-item d-block d-md-inline-block color-white p-3 px-lg-5">
    ...
    <div class="search-toggle-modal">
        <div class="container h-100">
            <form action="/forum/api/search.php" class="row gx-0 rGf
            align-items-center search-toggle-container" method="GET">
...
<script id="sRBar" type="text/x-jsrender">
    <?php include LAF_ROOT_PATH . '/widgets/thread-display/simple-thread-widget.php'; ?>
</script>
<script>
